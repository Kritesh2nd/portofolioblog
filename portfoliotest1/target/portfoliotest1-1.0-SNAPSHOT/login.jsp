    ...
    <div class="mainbody flex fdc">
      ...
      <div class="box2 borde flex aic jcc">
        <%
          if(showlogin==true){
        %>
        <form action="login.jsp" method="POST" class="form borderx1">
          <div class="formtitle">Log In</div>
          <div class="formtxt1 formtxt0">Email</div>
          <input type="text" class="inpbox1 inpbox0 borderx1" name="email">
          <div class="formtxt2 formtxt0">Password</div>
          <input type="text" class="inpbox2 inpbox0 borderx1"name="password">
          <div class="formtxt3 formtxt0 borderx1 none">
            <%
                String inpemail = request.getParameter("email");
                String inppassword = request.getParameter("password");
                String tblname="",tbluname="",tblemail="",tblpass="";
                try{
          ...
          <div class="btnbox2 borde flex">
            <a href="register.jsp" class="ahrlink registerbtn borderx1 w100">
              Register
            </a>
          </div>
